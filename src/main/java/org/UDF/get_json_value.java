...
public class get_json_value extends UDF{
    ...
    public List<String> evaluate(String jsonStr, String targetKey) {
        return evaluate(jsonStr, targetKey, null, null);
    }
    ...
    public static void main(String[] args) {
        ...
        get_json_value get_json_value = new get_json_value();
